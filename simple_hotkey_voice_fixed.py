...
# -*- coding: utf-8 -*-
"""
シンプルホットキー音声認識システム - 修正版
PyAudio不要・軽量実装 + 柔軟ホットキー検出
"""
...
class SimpleHotkeyVoice:
    ...
    def __init__(self, bot_instance, voice_callback: Optional[Callable] = None):
        ...
        print("🎮 シンプルホットキー音声システム（修正版）初期化完了")
    ...
    def start_listening(self) -> bool:
        ...
        try:
            ...
            print("🎮 ホットキー監視開始: Ctrl+Shift+Alt で音声録音（柔軟検出）")
            return True
    ...
    def _on_key_press(self, key):
        ...
        try:
            ...
            # デバッグ情報表示
            status = self._get_key_status_for_debug(self.pressed_keys)
            print(f"🔽 {key} → {status}")
    ...
    def get_status(self):
        ...
        return {
            ...
            'version': 'fixed_flexible_detection'
        }
